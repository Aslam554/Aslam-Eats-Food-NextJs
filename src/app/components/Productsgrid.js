...
text-xl font-semibold'> Have Some Dishes!</h1>
      <h1 data-aos="zoom-in" data-aos-delay="200" className='text-black font-semibold text-[42px] leading-[50px] text-center'>Eat Man Yummy!</h1>
...
lg:grid-cols-4 grid-cols-1 justify-center items-center gap-10 mt-5'>
        {
          products.map((item, index) =>
            <div id="product-box" key={index} className="flex flex-col hover:scale-[1.05] transition-all duration-300 justify-center items-center gap-2 bg-white p-4 rounded-lg cursor-pointer relative">
              <Image   src={item.img} alt="" className='w-[300px] h-[280px] rounded-lg'  />
              ...
              <div className='flex justify-between items-center gap-6 mt-3'> 
               ...
               <button className='bg-green-500 text-white px-4 py-2 rounded-lg text-[13px] font-semibold'>ORDER NOW 20%</button>
          </div >
        </div >
         </div >)
        }
